...
public class StartMenu {
    ...
    public static GridPane getStartGrid() {
        ...
        welcomeText.setFont(Font.font(null, FontWeight.EXTRA_BOLD,24));

        chooseSymbolText.setFont(Font.font(null, FontWeight.EXTRA_BOLD,24));

        crossRadio.setToggleGroup(symbolsGroup);
        circleRadio.setToggleGroup(symbolsGroup);
        symbolsGroup.selectToggle(crossRadio);

        nameText.setFont(Font.font("Geneva",15));
